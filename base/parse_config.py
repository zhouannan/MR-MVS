...
class ConfigParser:
    def __init__(self, config, resume=None, modification=None, run_id=None, mkdir=True):
        """
    ...
    def from_args(cls, args, options='', mkdir=True):
        ...
        import argparse
        if not isinstance(args, tuple) and not isinstance(args, argparse.Namespace) and not isinstance(args, EasyDict):
